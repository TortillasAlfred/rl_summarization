...
#SBATCH --output=/project/def-adurand/magod/rl_summ/slurm_outputs/%A.out       # Default write output on scratch, to jobID_arrayID.out file
...
python -um src.scripts.linsit_exp_priors --data_path $SLURM_TMPDIR/linsit_dataset/
