...
def main(_config, cluster=None):
    ...
    logging.info("Beginning LinSIT exp priors script with following config :")
...
if __name__ == "__main__":
    base_configs = yaml.load(open("./configs/linsit_exp_priors.yaml"), Loader=yaml.FullLoader)
