...
class RLSumOH(pl.LightningModule):
    def __init__(self, dataset, reward, hparams):
        super(RLSumOH, self).__init__()
    ...
    def mcts(self, states, valid_sentences):
    ...
    def from_config(dataset, reward, config):
        return RLSumOH(dataset, reward, config,)
